...
def model(X_train, Y_train, X_test, Y_test,learning_rate=0.009,
	...
	with sess.as_default():
		...
		plt.title("larger CNN run 2\n "+str(title)+" training acc: {} validation acc: {}".format(train_accuracy,test_accuracy))#"Learning rate =" + str(learning_rate))
		plt.savefig("larger CNN run2 "+(title)+".png")
		plt.show()
...
_,_, params_vat_large = model(train_x,train_y,test_x,test_y,VAT = False, large_files = False
                              ,learning_rate = 0.009, num_epochs = 5, minibatch_size = 1024, print_cost = True)
total_end = time.time()
hrs = 0
...
start = time.time()
_,_, params_vat_large = model(train_x,train_y,test_x,test_y,VAT = False, large_files = False
                              ,learning_rate = 0.009, num_epochs = 3500, minibatch_size = 1024, print_cost = True)
total_end = time.time()
hrs = 0
mins = (total_end-start)/60
if mins > 60:
...
_,_, params_vat_large = model(train_x3,train_y3,test_x,test_y,VAT = True, large_files = False
                              ,learning_rate = 0.009, num_epochs = 3000, minibatch_size = 1024, print_cost = True)
total_end = time.time()
hrs = 0
mins = (total_end-start)/60
if mins > 60:
